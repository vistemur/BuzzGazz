...
public class FindSessionsWindow extends BuzzWindow {
    ...
    public FindSessionsWindow(BuzzWindow backWindow) {
        super(backWindow);
    }
    ...
    protected void initialize() {
        ...
        sessionsTable.setForeground(Buzzain);
        sessionsTable.setGridColor(Buzzain);
        sessionsTable.getTableHeader().setForeground(Buzzain);
        sessionsTable.setSelectionBackground(Color.pink);
    ...
    protected void resizeLayout() {
        ...
        sessionsScrollTable.setPreferredSize(new Dimension( buzzGazzWindow.getWidth() - 20,
    ...
    protected void layout() {
        ...
        lowPanel.add(sessionsScrollTable);
    ...
    protected void setActions() {
        ...
        addButton.addActionListener(e -> navigateTo(new AddSessionWindow(buzzWindow)));
    ...
    private void find() {
        tableModel.setDataVector(sessions.getData(  nameTextField.getText(),
                                                    authorTextField.getText(),
                                                    timeFromTextField.getText(),
                                                    timeToTextField.getText(),
                                                    dateFromTextField.getText(),
